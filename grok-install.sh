#!/bin/bash
# =============================================
# PROJECT MASON v1.6 — FINAL INSTALLER
# Groq Free + New Splash + Bottom-Left Bubble
# =============================================
...
echo -e "${BOLD}${CYAN}                  PROJECT MASON v1.6${RESET}"
...
echo -e "${CYAN}═══ STEP 6: Deploying Project Mason (Groq) ═══${RESET}"
...
print("Project Mason (Groq) v1.6 running — Bottom Left")
while True:
...
grep -qxF '/userdata/roms/ports/grok/grok.py &' /userdata/system/custom.sh || echo '/userdata/roms/ports/grok/grok.py &' >> /userdata/system/custom.sh

echo -e "${GREEN}${BOLD}"
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║                  PROJECT MASON IS READY                      ║"
echo "║                                                              ║"
echo "║  In any game:                                                ║"
echo "║     Select + L1  → Chat bubble (bottom-left)                 ║"
echo "║     Select + R1  → Translation bubble                        ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo -e "${RESET}"
